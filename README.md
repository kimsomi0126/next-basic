...
- app/detail/[city]/page.tsx 폴더생성
  - http://localhost:3000/detail/대구
  - http://localhost:3000/detail/부산
  - http://localhost:3000/detail/대전
  - http://localhost:3000/detail/광주
  - http://localhost:3000/detail/서울
  - http://localhost:3000/detail/제주
...
const page = ({ params }: Props) => {
  ...
  return <div>{cityName}의 상세내용 페이지</div>;
};
